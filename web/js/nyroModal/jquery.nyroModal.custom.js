...
jQuery(function($, undefined) {
	...
	var $w = $(window),
		...
		_nmObj = {
			...
			closeButton: '<a id="nryroclosebutton" href="#" class="nyroModalClose nyroModalCloseButton nmReposition" title="Close">Close</a>',	// Close button HTML
			...
			size: function() {
                ...
                this.sizes.w = this.sizes.w;


                if(this.sizes.h > 650)
                    this.sizes.h = this.sizes.h + 15;

                this.sizes.h = this.sizes.h + 5;
