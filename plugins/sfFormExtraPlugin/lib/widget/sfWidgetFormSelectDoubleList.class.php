 ...
 * @version    SVN: $Id: sfWidgetFormSelectDoubleList.class.php,v 1.1.1.1 2012/03/24 12:16:27 nitin Exp $
 */
...
EOF
  ...
  public function render($name, $value = null, $attributes = array(), $errors = array())
  {
    ...
    $associatedWidget = new sfWidgetFormSelect(array('multiple' => true, 'choices' => $associated), array('size' => $size, 'tabindex'=>1, 'class' => $this->getOption('class_select').'-selected'));
    $unassociatedWidget = new sfWidgetFormSelect(array('multiple' => true, 'choices' => $unassociated), array('size' => $size, 'tabindex'=>1, 'class' => $this->getOption('class_select')));
