...
<div id="wapper">    
    ...
    <h1>
        <?php         
        echo __('Transfer Grave Invoice list');
        ?> 
    ...
    echo '</div></div>';
        ...
        echo jq_form_remote_tag(
                array(
                    'url'       => $ssModuleName.'/transferGraveInvoice?request_type=ajax_request',
            ...
            echo '<div style="width:100%;float:left;">';    
                if($snPageTotalGranteePages == 0): 
                    ...
                    echo '<div  id="contentlisting" >';
                        include_partial(
                            'list_middle_part_transfer_grave_invoice',
                            array(
                                'oTransferGrave'  	=> $oTransferGrave,
                                'amTransferGraveList'  	=> $amTransferGraveList,
                    ...
                    include_partial(
                        ...
                        array(
                            'amPagerSearchResults'  => $oTransferGrave, 
                            'amExtraParameters'     => $amExtraParameters
                        )
                    );
                endif;                            
