<?php 
    ...
    slot('second_update');
        include_partial(
            'global/paging',
            array(
                'pager_search_result'   => $oGranteeGraveHistoryList,
    ...
    slot('forth_update');
        include_partial('global/total_items',array('snTotalItems'=> $snPageTotalGranteeGraveHistoryPages));
    end_slot();
    echo get_slot('first_update');
    echo javascript_tag(
