...
<div id="wapper">
    ...
    <h1>
        ...
        <span id="no_of_items"><?php include_partial('global/total_items',array('snTotalItems'=> $snPageTotalGuardUserPages));?></span>
    </h1>
    ...
    <?php
        ...
        echo '<div>';
            echo '<div style="width:80%;float:left;">';    	
                if($snPageTotalGuardUserPages == 0): 
                    ...
                    echo '<div id="contentlisting">';
                        include_partial(
                            'list_middle_part',
                            array(
                                'oGuardUserList'    => $oGuardUserList,
                                'amGuardUserList'   => $amGuardUserList,
                    ...
                    include_partial(
                        ...
                        array(
                            'amPagerSearchResults'  => $oGuardUserList, 
                            'amExtraParameters'     => $amExtraParameters,
                        )
                    );
                endif;
    ...
    if($snPageTotalGuardUserPages > 0):
        echo javascript_tag('
            ...
            function sortingdiv()
            {
                ...
                showHideSortDiv("sort_div_last_name","field_div_last_name");
                showHideSortDiv("sort_div_organisation","field_div_organisation");
                showHideSortDiv("sort_div_group_id","field_div_group_id");
