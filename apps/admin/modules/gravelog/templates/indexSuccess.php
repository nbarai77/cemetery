...
<div id="wapper">    
    ...
    <div id="result"></div>
    <h1>
        <?php echo __('Grave Log list');?> 
        <span id="no_of_items"><?php include_partial('global/total_items',array('snTotalItems'=> $snPageTotalGuardGroupPages));?></span>		
    ...
    <?php
		...
		echo input_hidden_tag('logtype','grave', array('readonly' => true));
            ...
            echo '<div style="width:80%;float:left;">';    
                    ...
                    echo '<div  id="contentlisting" >';
                        include_partial(
                            'list_middle_part',
                            array(
                                'oGuardGroupList'   => $oGuardGroupList,
                                'amGuardGroupList'  => $amGuardGroupList,
                    ...
                    include_partial(
                        ...
                        array(
                            'amPagerSearchResults'  => $oGuardGroupList, 
                            'amExtraParameters'     => $amExtraParameters
                        )
                    );
...
<?php 
	...
	echo javascript_tag('
		...
		function savePDF()
		{
			...
			ssURL = ssURL+"?logtype=gravelog&cemetery_id="+jQuery("#searchCemId").val()+"&user_id="+jQuery("#searchUserId").val()+"&operation_date="+jQuery("#searchOperationDate").val();
