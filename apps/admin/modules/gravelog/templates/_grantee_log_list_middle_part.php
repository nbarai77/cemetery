                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tbody>
                        <tr>
							...
							<th width="10%" align="left" valign="top" class="none"><?php   echo __('Operation'); ?></th>
							<th width="12%" align="left" valign="top" class="none"><?php   echo __('Transfer From'); ?></th>
							<th width="12%" align="left" valign="top" class="none"><?php   echo __('Transfer To'); ?></th>
                        ...
                        <?php foreach($sf_data->getRaw('amGranteeLogList') as $snKey=>$asValues): ?>
