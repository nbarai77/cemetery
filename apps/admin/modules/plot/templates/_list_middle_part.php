...
<div id="main" class="listtable bordernone">
    <div class="maintablebg ">
        <?php 
            if(count($amArPlotList) > 0):  
                echo input_hidden_tag('admin_act');
                echo input_hidden_tag('idplot');
        ?>
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tbody>
                        <tr>
							...
							<?php   echo __('Plot Name'); ?>
							<div id="field_div_plot_name" class="assanding">
								<a href="javascript:void(0);"> <?php echo image_tag('admin/ass-a.gif');?> </a>
								<div id="sort_div_plot_name" class="inn_drupdownSort" style="display:none">
									<?php   
										include_partial(
											'global/sort_ajaxmain',
											array(
												'ssFieldName'       => 'plot_name',
                        ...
                        <?php foreach($sf_data->getRaw('amArPlotList') as $snKey=>$asValues): ?>
                            <tr class="<?php echo ($snKey%2 == 0) ? "even" : "odd";?>">
								...
								<td align="left" valign="top"> 
									<?php 
										echo link_to($asValues['plot_name'],url_for($ssModuleName.'/addedit?id='.$asValues['id'].'&'.html_entity_decode($amExtraParameters['ssQuerystr'])),												
											array('title' => $asValues['plot_name'],'class' => 'link1'));
									?>
								</td>
								<?php if($sf_user->getAttribute('issuperadmin') == 1): ?>
                                ...
                                <td align="center" valign="top">
                                    <?php 
                                        echo link_to(image_tag('admin/edit.gif'),
                                            ...
                                            array('title'=>__('Edit Plot') ,'class'=>'link1'));
                                    ?>
                                </td>
                            </tr>
                        <?php endforeach;?>
