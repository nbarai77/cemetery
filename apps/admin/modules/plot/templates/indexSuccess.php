...
<div id="wapper">    
    ...
    <div id="result"></div>
    <h1>
        <?php echo __('Plot list');?> 
        <span id="no_of_items"><?php include_partial('global/total_items',array('snTotalItems'=> $snPageTotalArPlotPages));?></span>
    </h1>
                ...
                if($snPageTotalArPlotPages == 0): 
                    ...
                    echo '<div  id="contentlisting" >';
                        include_partial(
                            'list_middle_part',
                            array(
                                'oArPlotList'  	=> $oArPlotList,
                                'amArPlotList'  	=> $amArPlotList,
                    ...
                    include_partial(
                        ...
                        array(
                            'amPagerSearchResults'  => $oArPlotList, 
                            'amExtraParameters'     => $amExtraParameters
                        )
                    );
                endif;                            
