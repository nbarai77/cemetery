<?php 
    ...
    slot('first_update');
        include_partial(
            'list_middle_part',
            array(
                'oArGraveMaintenanceList'	=> $oArGraveMaintenanceList,
                'amArGraveMaintenanceList'  	=> $amArGraveMaintenanceList,
                ...
                'inactivateIds'     => 'idgravemaintenance',
            )
        );
    end_slot();
    ...
    slot('second_update');
        include_partial(
            'global/paging',
            array(
                'pager_search_result'   => $oArGraveMaintenanceList,
    ...
    slot('forth_update');
        include_partial('global/total_items',array('snTotalItems'=> $snPageTotalArGraveMaintenancePages));
    end_slot();
