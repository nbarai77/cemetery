<div id="main" class="listtable">
    <div class="maintablebg">
        <?php 
            if(count($amGuardPermissionList) > 0):  
                echo input_hidden_tag('admin_act');
                echo input_hidden_tag('idpermission');
        ?>
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tbody>
                        <tr>
                            ...
                            <th width="76%" align="left" valign="top" class="none">
                        ...
                        <?php foreach($sf_data->getRaw('amGuardPermissionList') as $snKey=>$asValues): ?>
                            <tr class="<?php echo ($snKey%2 == 0) ? "even" : "odd";?>">
                                <td align="left" valign="top" class="checkStar">
                                    <?php  echo checkbox_tag('id_permission[]',$asValues['id'], false, array('class'=>'','onclick'=>"uncheck(this,'all','$inactivateIds')"));?>
                                </td>

                                <td align="left" valign="top"> <?php echo $asValues['name']; ?> </td>

                                <td align="left" valign="top"> <?php echo $asValues['description']; ?> </td>
                                ...
                                <td align="center" valign="top">
                                    <?php 
                                        echo link_to(image_tag('admin/edit.gif'),
                                            ...
                                            array('title'=>__('Edit permission') ,'class'=>'link1'));
                                    ?>
                                </td>
                            </tr>
                        <?php endforeach;?>
