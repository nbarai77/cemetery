...
<div id="main" class="listtable bordernone">
    <div class="maintablebg">
        <?php 
            if(count($amCemChapelList) > 0):  
                echo input_hidden_tag('admin_act');
                echo input_hidden_tag('idchapel');
        ?>
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tbody>
                        <tr>
							...
							<th width="34%" align="left" valign="top" class="none">
							<?php   echo __('Name'); ?>
                        ...
                        <?php foreach($sf_data->getRaw('amCemChapelList') as $snKey=>$asValues): ?>
                                ...
                                <td align="center" valign="top">
                                    <?php 
                                        echo link_to(image_tag('admin/edit.gif'),
                                            ...
                                            array('title'=>__('Edit Chapel Type') ,'class'=>'link1'));
                                    ?>
                                </td>
                            </tr>
                        <?php endforeach;?>
