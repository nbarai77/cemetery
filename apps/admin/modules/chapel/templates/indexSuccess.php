...
<div id="wapper">    
    ...
    <div id="result"></div>
    <h1>
        <?php echo __('Chapel Type list');?> 
        <span id="no_of_items"><?php include_partial('global/total_items',array('snTotalItems'=> $snPageTotaloCemChapelPages));?></span>
    </h1>
    ...
    <?php
        ...
        echo '<div>';
            echo '<div style="width:80%;float:left;">';    
                if($snPageTotaloCemChapelPages == 0): 
                    ...
                    echo '<div  id="contentlisting" >';
                        include_partial(
                            'list_middle_part',
                            array(
                                'oCemChapelList'  	=> $oCemChapelList,
                                'amCemChapelList'  	=> $amCemChapelList,
                    ...
                    include_partial(
                        ...
                        array(
                            'amPagerSearchResults'  => $oCemChapelList, 
                            'amExtraParameters'     => $amExtraParameters
                        )
                    );
                endif;                            
