    ...
    <?php
        ...
        include_partial(
            ...
            array(
                ...
                'add_new_url'           => url_for($ssModuleName.'/addedit?'.html_entity_decode($amExtraParameters['ssQuerystr'])),
				'add_multiple_url'      => url_for($ssModuleName.'/importGraves?'.html_entity_decode($amExtraParameters['ssQuerystr'])),
				'grave_link_url'        => url_for($ssModuleName.'/graveLink?'.html_entity_decode($amExtraParameters['ssQuerystr'])),
                'bStatusButton'         => 'false',
