...
<div id="wapper">    
    ...
    <div id="result"></div>
    <h1>
        <?php echo __('Department Delegation List');?> 
        <span id="no_of_items"><?php include_partial('global/total_items',array('snTotalItems'=> $snPageTotalDepartmentPages));?></span>
    </h1>
    ...
    <?php
        ...
        echo '<div>';
            echo '<div style="width:80%;float:left;">';    
                if($snPageTotalDepartmentPages == 0): 
                    ...
                    echo '<div  id="contentlisting" >';
                        include_partial(
                            'list_middle_part',
                            array(
                                'oDepartmentList'   => $oDepartmentList,
                                'amDepartmentList'  => $amDepartmentList,
                    ...
                    include_partial(
                        ...
                        array(
                            'amPagerSearchResults'  => $oDepartmentList, 
                            'amExtraParameters'     => $amExtraParameters
                        )
                    );
                endif;                            
