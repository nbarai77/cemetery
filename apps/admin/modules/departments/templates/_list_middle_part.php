...
<div id="main" class="listtable">
    <div class="maintablebg">
        <?php 
            if(count($amDepartmentList) > 0):  
                echo input_hidden_tag('admin_act');
                echo input_hidden_tag('iddepartment');
        ?>
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tbody>
                        <tr>
                            <th width="3%" align="left" valign="top" class="none">&nbsp;</th>
                            <th width="28%" align="left" valign="top" class="none">
                                <?php   echo __('Name'); ?>
							...
							<th width="20%" align="left" valign="top" class="none">
                              ...
                              <th width="16%" align="left" valign="top" class="none">
                                <?php echo __('Status'); ?>
                        ...
                        <?php foreach($sf_data->getRaw('amDepartmentList') as $snKey=>$asValues): ?>
                            <tr class="<?php echo ($snKey%2 == 0) ? "even" : "odd";?>">
								...
								<td align="left" valign="top"> <?php echo $asValues['cemetery']; ?> </td>
								<td align="left" valign="top"> <?php echo $asValues['contact_number']; ?> </td>
                                ...
                                <td align="center" valign="top">
                                    <?php 
                                        echo link_to(image_tag('admin/edit.gif'),
                                            ...
                                            array('title'=>__('Edit Department Delegation') ,'class'=>'link1'));
                                    ?>
                                </td>
                            </tr>
                        <?php endforeach;?>
