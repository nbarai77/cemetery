							...
							array('url'		=> url_for('gravesearch/getPlotListAsPerRow'),
								  ...
								  'complete'=> '$("#IdAjaxLocaderPlot").hide();'.jq_remote_function(
												array('url'		=> url_for('gravesearch/getGraveListAsPerPlot'),
													  'update'	=> 'grave_list',
													  'with'	=> "'row_id='+$('#grave_ar_row_id').val()+'&country_id='+$('#grave_country_id').val()+'&cemetery_id='+$('#grave_cem_cemetery_id').val()+'&area_id='+$('#grave_ar_area_id').val()+'&section_id='+$('#grave_ar_section_id').val()",
