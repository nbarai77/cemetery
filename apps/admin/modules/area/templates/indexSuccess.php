...
<div id="wapper">    
    ...
    <div id="result"></div>
    <h1>
        <?php echo __('Area list');?> 
        <span id="no_of_items"><?php include_partial('global/total_items',array('snTotalItems'=> $snPageTotalArAreaPages));?></span>
    </h1>
                ...
                if($snPageTotalArAreaPages == 0): 
                    ...
                    echo '<div  id="contentlisting" >';
                        include_partial(
                            'list_middle_part',
                            array(
                                'oArAreaList'  		=> $oArAreaList,
                                'amArAreaList'  	=> $amArAreaList,
                    ...
                    include_partial(
                        ...
                        array(
                            'amPagerSearchResults'  => $oArAreaList, 
                            'amExtraParameters'     => $amExtraParameters
                        )
                    );
                endif;                            
