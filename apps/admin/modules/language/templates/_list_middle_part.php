    ...
    <div class="maintablebg">
        <?php 
            if(count($amGuardGroupList) > 0):  
                ...
                echo input_hidden_tag('idlanguage');
        ?>
                    ...
                    <tbody>
                        ...
                        <?php foreach($sf_data->getRaw('amGuardGroupList') as $snKey=>$asValues): ?>
                            <tr class="<?php echo ($snKey%2 == 0) ? "even" : "odd";?>">
                                ...
                                <td align="left" valign="top"> <?php echo $asValues['language_name']; ?> </td>
                                <td align="left" valign="top"> <?php echo $asValues['culture']; ?> </td>
