...
<div id="wapper">    
    ...
    <div id="result"></div>
    <h1>
        <?php echo __('Section list');?> 
        <span id="no_of_items"><?php include_partial('global/total_items',array('snTotalItems'=> $snPageTotalArSectionPages));?></span>
    </h1>
    ...
    <?php
        ...
        echo '<div>';
            echo '<div style="width:80%;float:left;">';    
                if($snPageTotalArSectionPages == 0): 
                    ...
                    echo '<div  id="contentlisting" >';
                        include_partial(
                            'list_middle_part',
                            array(
                                'oArSectionList'  	=> $oArSectionList,
                                'amArSectionList'  	=> $amArSectionList,
                    ...
                    include_partial(
                        ...
                        array(
                            'amPagerSearchResults'  => $oArSectionList, 
                            'amExtraParameters'     => $amExtraParameters
                        )
                    );
                endif;                            
    ...
    if($snPageTotalArSectionPages > 0):
        echo javascript_tag('
            ...
            function sortingdiv()
            {
                ...
                showHideSortDiv("sort_div_section","field_div_section");
