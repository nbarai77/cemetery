<?php
    ...
    slot('first_update');
        include_partial(
            'list_middle_part',
            array(
                'oCatalogList'  	=> $oCatalogList,
                'amCatalogList'  	=> $amCatalogList,
    ...
    slot('second_update');
        include_partial(
            'global/paging',
            array(
                'pager_search_result'   => $oCatalogList,
    ...
    slot('forth_update');
        include_partial('global/total_items',array('snTotalItems'=> $snPageTotaloAwardPages));
    end_slot();
