...
<div id="wapper">    
    ...
    <div id="result"></div>
    <h1>
        <?php echo __('Row list');?> 
        <span id="no_of_items"><?php include_partial('global/total_items',array('snTotalItems'=> $snPageTotalArRowPages));?></span>
    </h1>
                ...
                if($snPageTotalArRowPages == 0): 
                    ...
                    echo '<div  id="contentlisting" >';
                        include_partial(
                            'list_middle_part',
                            array(
                                'oArRowList'  	=> $oArRowList,
                                'amArRowList'  	=> $amArRowList,
                    ...
                    include_partial(
                        ...
                        array(
                            'amPagerSearchResults'  => $oArRowList, 
                            'amExtraParameters'     => $amExtraParameters
                        )
                    );
                endif;                            
