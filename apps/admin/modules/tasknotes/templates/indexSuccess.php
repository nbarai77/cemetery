...
<div id="wapper">    
    ...
    <div id="result"></div>
    <h1>
        <?php echo __('Task Notes List');?> 
        <span id="no_of_items"><?php include_partial('global/total_items',array('snTotalItems'=> $snPageTotalUserTaskNotesPages));?></span>
    </h1>
    ...
    <?php
        ...
        echo '<div>';
            echo '<div style="width:80%;float:left;">';    
                if($snPageTotalUserTaskNotesPages == 0): 
                    ...
                    echo '<div  id="contentlisting" >';
                        include_partial(
                            'list_middle_part',
                            array(
                                'oUserTaskNotesList'  	=> $oUserTaskNotesList,
                                'amUserTaskNotesList'  	=> $amUserTaskNotesList,
                    ...
                    include_partial(
                        ...
                        array(
                            'amPagerSearchResults'  => $oUserTaskNotesList, 
                            'amExtraParameters'     => $amExtraParameters
                        )
                    );
                endif;                            
...
<?php 
	...
	jQuery(document).ready(function() 
	{
		...
		$("#searchEntryDate").datepicker(params);
		$("#searchDueDate").datepicker(params);			
	});
	function sortingdiv()
	{
		showHideSortDiv("sort_div_task_title","field_div_task_title");
