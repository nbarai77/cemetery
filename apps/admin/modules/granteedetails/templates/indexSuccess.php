...
<div id="wapper">    
    ...
    <div id="result"></div>
    <h1>
        <?php echo __('Grantee Details list');?> 
        <span id="no_of_items"><?php include_partial('global/total_items',array('snTotalItems'=> $snPageTotalGranteeDetailsPages));?></span>
    </h1>
    ...
    <?php
        ...
        include_partial(
            ...
            array(
                ...
                'id_checkboxes'         => 'id[]',
                'inactivateIds'         => 'idgranteedetails',
        ...
        echo '<div>';
            echo '<div style="width:80%;float:left;">';    
                if($snPageTotalGranteeDetailsPages == 0): 
                    ...
                    echo '<div  id="contentlisting" >';
                        include_partial(
                            'list_middle_part',
                            array(
                                'oGranteeDetailsList'  	=> $oGranteeDetailsList,
                                'amGranteeDetailsList'  	=> $amGranteeDetailsList,
                    ...
                    include_partial(
                        ...
                        array(
                            'amPagerSearchResults'  => $oGranteeDetailsList, 
                            'amExtraParameters'     => $amExtraParameters
                        )
                    );
                endif;                            
