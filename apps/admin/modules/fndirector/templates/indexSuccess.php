...
<div id="wapper">    
    ...
    <div id="result"></div>
    <h1>
        <?php echo __('Funeral director list');?> 
    ...
    <?php
        ...
        echo '<div>';
            echo '<div style="width:80%;float:left;">';    
                if($snPageTotalGuardGroupPages == 0): 
    ...
    if($snPageTotalGuardGroupPages > 0):
        echo javascript_tag('
            ...
            function sortingdiv()
            {
                ...
                showHideSortDiv("sort_div_company_name","field_div_company_name");
