    ...
    <div class="maintablebg">
        <?php 
            if(count($amGuardGroupList) > 0):  
                ...
                echo input_hidden_tag('idfndfndirector');
        ?>
                <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-style:solid ">
                    <tbody>
                        <tr>
                            ...
                            <th width="5%" align="left" valign="top" class="none">
                                <?php   echo __('Code'); ?>
                                <div id="field_div_code" class="assanding">
                                    <a href="javascript:void(0);"> <?php echo image_tag('admin/ass-a.gif');?> </a>
                                    <div id="sort_div_code" class="inn_drupdownSort" style="display:none">
                                        <?php   
                                            include_partial(
                                                'global/sort_ajaxmain',
                                                array(
                        ...
                        <?php foreach($sf_data->getRaw('amGuardGroupList') as $snKey=>$asValues): ?>
                            <tr class="<?php echo ($snKey%2 == 0) ? "even" : "odd";?>">
								...
								<td align="left" valign="top"> <?php echo $asValues['CemCemetery']['name']; ?> </td>
								<td align="left" valign="top"> <?php echo $asValues['phone']; ?> </td>
								<td align="left" valign="top"> <?php echo $asValues['title'].' '.$asValues['first_name']; ?> </td>																
                                ...
                                <td align="center" valign="top">
                                    <?php 
                                        echo link_to(image_tag('admin/edit.gif'),
                                            ...
                                            array('title'=>__('Edit Funeral Director') ,'class'=>'link1'));
                                    ?>
                                </td>
                            </tr>
                        <?php endforeach;?>
