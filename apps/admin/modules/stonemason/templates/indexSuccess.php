...
<div id="wapper">    
    ...
    <div id="result"></div>
    <h1>
        <?php echo __('Stone Mason list');?> 
        <span id="no_of_items"><?php include_partial('global/total_items',array('snTotalItems'=> $snPageTotalCemStonemasonPages));?></span>
    </h1>
    ...
    <?php
        ...
        echo '<div>';
            echo '<div style="width:80%;float:left;">';    
                if($snPageTotalCemStonemasonPages == 0): 
                    ...
                    echo '<div  id="contentlisting" >';
                        include_partial(
                            'list_middle_part',
                            array(
                                'oCemStonemasonList'  		=> $oCemStonemasonList,
                                'amCemStonemasonList'  	=> $amCemStonemasonList,
                    ...
                    include_partial(
                        ...
                        array(
                            'amPagerSearchResults'  => $oCemStonemasonList, 
                            'amExtraParameters'     => $amExtraParameters
                        )
                    );
                endif;                            
