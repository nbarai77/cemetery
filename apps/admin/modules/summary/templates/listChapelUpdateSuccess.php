<?php 
    ...
    slot('second_update');
        include_partial(
            'global/paging',
            array(
                'pager_search_result'   => $oChapelSummaryList,
    ...
    echo javascript_tag(
        jq_update_element_function('chapellisting', array('content' => get_slot('first_update'))).
        jq_update_element_function('chapelbottompagingdiv', array('content' => get_slot('second_update'),))
    );
