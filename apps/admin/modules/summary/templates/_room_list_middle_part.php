...
<h1>
	<?php echo __('Room');?>
	<span id="no_of_items"><?php include_partial('global/total_items',array('snTotalItems'=> $snPageTotalRoomRecords));?></span>	
</h1>
    ...
    <div class="maintablebg">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tbody>
				...
				<?php  if(count($amRoomSummaryList) > 0):  
					foreach($sf_data->getRaw('amRoomSummaryList') as $snKey=>$asValues): 
					...
					<tr class="<?php echo ($snKey%2 == 0) ? "even-small" : "odd-small";?>">
						...
						<td align="left" valign="top">
							<?php echo date('H:i:s',strtotime($asValues['room_time_from']));?>
						</td>
						<td align="left" valign="top"> 
							<?php echo date('H:i:s',strtotime($asValues['room_time_to']));?>
						</td>
						
						<td align="left" valign="top"> 
							<?php echo $asValues['room_types'];?>
						</td>				
						<td align="left" valign="top"> 
							<?php 
