...
<h1>
	<?php echo __('Ashes');?>         
	<span id="no_of_items"><?php include_partial('global/total_items',array('snTotalItems'=> $snPageTotalAshesRecords));?></span>
</h1>
    ...
    <div class="maintablebg">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tbody>
				...
				<?php  if(count($amAshesSummaryList) > 0):  
					foreach($sf_data->getRaw('amAshesSummaryList') as $snKey=>$asValues): ?>
