...
<h1>
	<?php echo __('Exhumation');?>
	<span id="no_of_items"><?php include_partial('global/total_items',array('snTotalItems'=> $snPageTotalExhumationRecords));?></span>
</h1>
    ...
    <div class="maintablebg">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			<tbody>
				...
				<?php  if(count($amExhumationSummaryList) > 0):  
					foreach($sf_data->getRaw('amExhumationSummaryList') as $snKey=>$asValues): ?>
