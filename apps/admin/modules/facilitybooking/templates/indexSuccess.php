...
<div id="wapper">    
    ...
    <div id="result"></div>
    <h1>
        <?php echo __('Facility Booking list');?> 
        <span id="no_of_items"><?php include_partial('global/total_items',array('snTotalItems'=> $snPageTotalFacilityBookingPages));?></span>
    </h1>
    ...
    <?php
        ...
        include_partial(
            ...
            array(
                ...
                'id_checkboxes'         => 'id[]',
                'inactivateIds'         => 'idfacilitybooking',
				...
				'bFinalizedStatusBtn'	=> 'true'
            )
        );

        echo '<div>';
            echo '<div style="width:80%;float:left;">';    
                if($snPageTotalFacilityBookingPages == 0): 
                    ...
                    echo '<div  id="contentlisting" >';
                        include_partial(
                            'list_middle_part',
                            array(
                                'oFacilityBookingList'  => $oFacilityBookingList,
                                'amFacilityBookingList' => $amFacilityBookingList,
                    ...
                    include_partial(
                        ...
                        array(
                            'amPagerSearchResults'  => $oFacilityBookingList, 
                            'amExtraParameters'     => $amExtraParameters
                        )
                    );
                endif;                            
    ...
    if($snPageTotalFacilityBookingPages > 0):
        echo javascript_tag('
            ...
            function sortingdiv()
            {
                ...
                showHideSortDiv("sort_div_email","field_div_email");
                showHideSortDiv("sort_div_chapel","field_div_chapel");
                showHideSortDiv("sort_div_room","field_div_room");
