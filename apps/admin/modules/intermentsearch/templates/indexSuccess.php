...
<div id="wapper">    
    ...
    <?php
        ...
        echo input_hidden_tag('interment_cem_cemetery_id',$ssSearchCemCemeteryId);
        echo input_hidden_tag('interment_ar_area_id',$ssSearchArAreaId);
        echo input_hidden_tag('interment_ar_section_id',$ssSearchArSectionId);
        echo input_hidden_tag('interment_ar_row_id',$ssSearchArRowId);
        echo input_hidden_tag('interment_ar_plot_id',$ssSearchArPlotId);
        echo input_hidden_tag('interment_ar_grave_id',$ssSearchArGraveId);
        echo input_hidden_tag('interment_first_name',$ssSearchDeceasedFirstName);        
        
        echo input_hidden_tag('interment_middle_name',$ssSearchDeceasedMiddleName);        
        echo input_hidden_tag('interment_surname',$ssSearchDeceasedSurname);        
        echo input_hidden_tag('interment_date',$ssSearchIntermentDate);        
        echo input_hidden_tag('control_number',$ssSearchControlNumber);        
        echo input_hidden_tag('interment_dob',$ssSearchDeceasedDateOfBirth);        
        echo input_hidden_tag('interment_birth_place',$ssSearchDeceasedPlaceOfBirth);        
        echo input_hidden_tag('interment_birth_country_id',$ssSearchDeceasedCountryIdOfBirth);        
        echo input_hidden_tag('deceased_age',$ssSearchDeceasedAge);
