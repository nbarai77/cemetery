...
<div id="wapper">
<?php 
    echo $oCemRoomForm->renderFormTag(
        url_for($sf_params->get('module').'/'.$sf_params->get('action').(!$oCemRoomForm->getObject()->isNew() ? '?id='.$oCemRoomForm->getObject()->getId().'&'.html_entity_decode($amExtraParameters['ssQuerystr']) : '')), 
        array("name" => $oCemRoomForm->getName(), "method" => "post" ,'enctype'=>'multipart/form-data')
    );
?>
    <div class="comment_list"></div>
    <h1><?php echo $oCemRoomForm->getObject()->isNew() ?  __('Add New Room Type') : __('Edit Room Type');?></h1>
    <div id="message">
        <div id="success_msgs">
                		...
                		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="sub_table">
                    		...
                    		<tr>
                            	<td valign="middle" align="right" width="20%">
                                	<?php echo $oCemRoomForm['country_id']->renderLabel($oCemRoomForm['country_id']->renderLabelName()."<span class='redText'>*</span>");?>
                        		</td>
	
                            	<td valign="middle" width="80%">
                                	<?php 
                                	    if($oCemRoomForm['country_id']->hasError()):
                                    	    echo $oCemRoomForm['country_id']->renderError();
                                        endif;
									    echo $oCemRoomForm['country_id']->render(array('class'=>'inputBoxWidth')); 
								    ?>
                                </td>
                    		</tr>							
							<tr>
							...
							<tr>
                            	<td valign="middle" align="right" width="20%">
                                	<?php echo $oCemRoomForm['name']->renderLabel($oCemRoomForm['name']->renderLabelName()."<span class='redText'>*</span>");?>
                        		</td>
	
                            	<td valign="middle" width="80%">
                                	<?php 
                                	    if($oCemRoomForm['name']->hasError()):
                                    	    echo $oCemRoomForm['name']->renderError();
                                        endif;
									    echo $oCemRoomForm['name']->render(array('class'=>'inputBoxWidth')); 
								    ?>
                                </td>
                    		</tr>
							<tr>
                            	<td valign="middle" align="right" width="20%">
                                	<?php echo $oCemRoomForm['description']->renderLabel($oCemRoomForm['description']->renderLabelName() );?>
                        		</td>
	
                            	<td valign="middle" width="80%">
                                	<?php 
                                	    if($oCemRoomForm['description']->hasError()):
                                    	    echo $oCemRoomForm['description']->renderError();
                                        endif;
									    echo $oCemRoomForm['description']->render(array('class'=>'inputBoxWidth')); 
								    ?>
                                </td>
                    		</tr>							
                    		<tr>
    ...
    <?php
        ...
        echo $oCemRoomForm->renderHiddenFields(); 
    ?>
    </form>
</div>
<?php 
    ...
    echo javascript_tag("
		...
		{
			var snCountryId = jQuery('#room_country_id').val();
			var snCemeteryId = $('#room_cem_cemetery_id option').length;
			if(snCountryId > 0 && snCemeteryId == 1)
				callAjaxRequest(snCountryId,'".url_for('room/getCementryListAsPerCountry')."','cementery_list');
		});
