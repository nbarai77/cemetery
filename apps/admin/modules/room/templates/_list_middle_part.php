...
<div id="main" class="listtable bordernone">
    <div class="maintablebg">
        <?php 
            if(count($amCemRoomList) > 0):  
                echo input_hidden_tag('admin_act');
                echo input_hidden_tag('idroom');
        ?>
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tbody>
                        ...
                        <?php foreach($sf_data->getRaw('amCemRoomList') as $snKey=>$asValues): ?>
                                ...
                                <td align="center" valign="top">
                                    <?php 
                                        echo link_to(image_tag('admin/edit.gif'),
                                            ...
                                            array('title'=>__('Edit Room Type') ,'class'=>'link1'));
                                    ?>
                                </td>
                            </tr>
                        <?php endforeach;?>
