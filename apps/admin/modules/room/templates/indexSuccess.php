...
<div id="wapper">    
    ...
    <div id="result"></div>
    <h1>
        <?php echo __('Room Type list');?> 
        <span id="no_of_items"><?php include_partial('global/total_items',array('snTotalItems'=> $snPageTotalCemRoomPages));?></span>
    </h1>
                ...
                if($snPageTotalCemRoomPages == 0): 
                    ...
                    echo '<div  id="contentlisting" >';
                        include_partial(
                            'list_middle_part',
                            array(
                                'oCemRoomList'  	=> $oCemRoomList,
                                'amCemRoomList'  	=> $amCemRoomList,
                    ...
                    include_partial(
                        ...
                        array(
                            'amPagerSearchResults'  => $oCemRoomList, 
                            'amExtraParameters'     => $amExtraParameters
                        )
                    );
                endif;                            
