 ...
 * @version    SVN: $Id: CemRoomForm.class.php,v 1.1.1.1 2012/03/24 11:56:37 nitin Exp $
 */
sfProjectConfiguration::getActive()->loadHelpers(array('jQuery', 'Url'));
class CemRoomForm extends BaseCemRoomForm
{
	/**
    ...
    public function setWidgets(array $asWidgets)
    {
		...
		if(sfContext::getInstance()->getUser()->isSuperAdmin())
		{
			$this->widgetSchema['country_id'] = new sfWidgetFormChoice(
													...
													array('tabindex'=> 1, 'onChange' => "callAjaxRequest(this.value,'".url_for('room/getCementryListAsPerCountry')."','cementery_list');")
												);
			if($this->isNew())
	...
	public function updateObject($values = null)
	{
		if(sfContext::getInstance()->getUser()->isSuperAdmin())
		{
			...
			$snCemeteryId = sfContext::getInstance()->getRequest()->getParameter('room_cem_cemetery_id');
