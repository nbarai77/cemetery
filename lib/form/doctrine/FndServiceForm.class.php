 ...
 * @version    SVN: $Id: FndServiceForm.class.php,v 1.1.1.1 2012/03/24 11:56:24 nitin Exp $
 */
class FndServiceForm extends BaseFndServiceForm
{
  ...
  public function configure()
  {
   ...
   /**
    ...
    public function setWidgets(array $asWidgets)
    {
        ...
        $this->widgetSchema->setNameFormat('fnd_service[%s]'); 
    }  
    ...
    {
        BaseFndServiceForm::setValidators(
            array(
