...
/**
 * GranteeLogs form base class.
 *
 * @method GranteeLogs getObject() Returns the current form's model object
 *
 * @package    cemetery
 * @subpackage form
 ...
 */
abstract class BaseGranteeLogsForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'old_grantee'    => new sfWidgetFormInputText(),
      'new_grantee'    => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'old_grantee'    => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'new_grantee'    => new sfValidatorString(array('max_length' => 255, 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('grantee_logs[%s]');
