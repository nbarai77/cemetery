...
/**
 * Denomination form base class.
 *
 * @method Denomination getObject() Returns the current form's model object
 *
 * @package    cemetery
 * @subpackage form
 ...
 */
abstract class BaseDenominationForm extends BaseFormDoctrine
{
