 ...
 * @version    SVN: $Id: DiseaseForm.class.php,v 1.1.1.1 2012/03/24 11:56:37 nitin Exp $
 */
class DiseaseForm extends BaseDiseaseForm
{
  ...
  public function configure()
  {
   ...
   /**
    ...
    public function setWidgets(array $asWidgets)
    {
        ...
        $this->widgetSchema->setNameFormat('disease[%s]'); 
    }  
     ...
     *  
     */
    public function checkDiseaseNameExist($oValidator, $ssValue)
    {
        $snIdGroup = '';
        if(!$this->isNew())
            $snIdGroup = $this->getObject()->getId();

        $oSfGuardGroup = new Disease();
        $oResult    = $oSfGuardGroup->checkDiseaseNameExist($ssValue, $snIdGroup);
        unset($oSfGuardGroup);
