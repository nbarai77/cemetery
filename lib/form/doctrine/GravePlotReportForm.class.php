...
/**
 * GravePlotReport form.
 *
 * @package    cemetery
 * @subpackage GravePlotReport
 * @author     Prakash Panchal
 * @version    SVN: $Id: GravePlotReportForm.class.php,v 1.1.1.1 2012/03/24 11:56:27 nitin Exp $
 */
sfProjectConfiguration::getActive()->loadHelpers(array('jQuery', 'Url'));
class GravePlotReportForm extends BaseArGraveForm
{
	/**
