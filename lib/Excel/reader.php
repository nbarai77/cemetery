...
* @version    CVS: $Id: reader.php,v 1.1.1.1 2012/03/24 11:55:38 nitin Exp $
...
//exit;
    ...
    */
        ...
        if($res === false) {
            ...
            // bad file
                die('<font color="red">Your select file is not valid sample formtat.</font><br/><a href='.$_SERVER['HTTP_REFERER'].'>Go to Back</a>');
